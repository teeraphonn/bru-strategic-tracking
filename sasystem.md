...
ในระบบนี้ ยุทธศาสตร์ของมหาวิทยาลัยราชภัฏบุรีรัมย์จะถูกถ่ายทอดลงสู่ระดับปฏิบัติการจริงอย่างเป็นระบบผ่าน **การถ่ายทอดแผนยุทธศาสตร์สู่การปฏิบัติ (Cascading Strategic Hierarchy)**:

```mermaid
graph TD
    LDI["1. ประเด็นการพัฒนาท้องถิ่น (4 ด้าน: LDI1 - LDI4)<br/>กรอบการขับเคลื่อนเศรษฐกิจ สังคม สิ่งแวดล้อม การศึกษา"] --> S["2. แผนงานหลัก (6 แผนงาน: S1 - S6)<br/>ทิศทางหลักระดับมหาวิทยาลัยและโครงการร่วม"]
    S --> SS["3. แผนงานย่อย (8 แผนงานย่อย: SS1.1 - SS4.2)<br/>แนวทางการพัฒนาเฉพาะด้าน เช่น BCG, Soft Power, วิศวกรสังคม"]
    SS --> MP["4. โครงการหลักระดับมหาวิทยาลัย (10 โครงการหลัก: MP1.1 - MP4.3)<br/>'ร่มโครงการแม่ (Strategic Master Umbrella)' ควบคุมเป้าหมายสถาบัน"]
    MP --> P["5. โครงการปฏิบัติการของคณะ/สาขา (Operational Projects)<br/>ข้อเสนอโครงการที่คณะ/อาจารย์สร้างขึ้นเพื่อตอบสนองโครงการหลัก"]
    P --> ACT["6. กิจกรรมย่อยจริงในพื้นที่ (Activities)<br/>การปฏิบัติงานจริง บันทึกผลสำเร็จ งบประมาณจ่ายจริง และภาพถ่ายหลักฐาน"]
```

* **ระดับที่ 1: ประเด็นการพัฒนาท้องถิ่น (Local Development Issues - LDI1 ถึง LDI4)** — 4 ด้านหลักของการพัฒนาพื้นที่ (เศรษฐกิจ, สังคม, สิ่งแวดล้อม, การศึกษา)
* **ระดับที่ 2: แผนงานหลัก (Program Name - S1 ถึง S6)** — แผนงานยุทธศาสตร์ขับเคลื่อนหลัก 6 แผนงาน
* **ระดับที่ 3: แผนงานย่อย (Sub-Program Name - SS1.1 ถึง SS4.2)** — แนวทางการพัฒนาเฉพาะด้าน 8 แผนงานย่อย
* **ระดับที่ 4: โครงการหลักระดับมหาวิทยาลัย (Main Project Name - MP1.1 ถึง MP4.3)** — ร่มโครงการแม่ 10 โครงการหลักที่มหาวิทยาลัยกำหนดขึ้นจากส่วนกลาง (จัดเก็บในระบบผ่านตาราง `indicators`) เพื่อเป็นกรอบเป้าหมายรวม
* **ระดับที่ 5: โครงการปฏิบัติการ (Operational Projects)** — แผนงานโครงการที่คณะ สาขาวิชา หรืออาจารย์ผู้รับผิดชอบจัดทำขึ้นภายใต้โครงการหลัก เพื่อขอรับงบประมาณและนำไปปฏิบัติจริง (จัดเก็บในตาราง `projects`)
* **ระดับที่ 6: กิจกรรมย่อย (Activities)** — การจัดกิจกรรมและการปฏิบัติงานจริงในชุมชน มีการเบิกจ่ายงบประมาณจริง (`actual_budget`), รายงานผลผลิต (`completed_count`) และแนบภาพถ่ายหลักฐาน (`images`)
