          ...
          <div>
            <div className="flex items-center gap-2.5 mb-2">
              <span className="px-3 py-1 bg-white/10 backdrop-blur-md rounded-full text-xs font-bold text-indigo-300 border border-white/10 flex items-center gap-1.5">
                <FiFileText className="w-3.5 h-3.5 text-indigo-300" />
                <span>การออกรายงานระดับคณะ</span>
              </span>
            </div>
            <h1 className="text-xl md:text-2xl font-black tracking-tight text-white">ระบบรายงานสรุปผลงานความสำเร็จ (คณบดี)</h1>
            <p className="text-xs md:text-sm text-indigo-200/80 mt-1 font-medium max-w-2xl">
              ประมวลรายงานความก้าวหน้าโครงการ และยุทธศาสตร์ความก้าวหน้ารายคณะและภาควิชา
            </p>
          </div>
        </div>
      </div>
