        ...
        <div className="space-y-3">
          {(mainProjects || []).map((mp) => {
            ...
            const statusConfig = {
              ...
              GRAY: { label: 'ยังไม่มีโครงการ', badge: 'bg-slate-50 text-slate-500 border-slate-200', dot: 'bg-slate-400' }
                ...
                >
                  ...
                  <div className="flex items-center gap-4 shrink-0 justify-between lg:justify-end border-t lg:border-t-0 pt-3 lg:pt-0 border-slate-100">
                    ...
                    <div className="text-left lg:text-right">
                      <div className="text-[10px] font-bold text-slate-400 uppercase">โครงการปฏิบัติการ</div>
                        ...
                        <table className="w-full text-xs text-left border-collapse min-w-[650px]">
                          <thead>
                            <tr className="bg-slate-50 border-b border-slate-100 text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">
                              <th className="py-2.5 px-3">ชื่อโครงการปฏิบัติการย่อย (Operational Project)</th>
                              <th className="py-2.5 px-3 w-40">คณะ / ภาควิชา</th>
                            ...
                            {mp.projects.map((subP) => (
                              <tr key={subP.id} className="hover:bg-slate-50/60 transition-colors">
                                ...
                                <td className="py-2.5 px-3 text-slate-600">
                                  <div className="font-semibold text-[11px]">{subP.facultyName}</div>
                                  <div className="text-[10px] text-slate-400">{subP.departmentName}</div>
                                </td>
