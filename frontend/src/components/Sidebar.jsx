  ...
  const navItems = user?.role === 'ADMIN' ? [
    { to: '/',             name: 'แดชบอร์ดภาพรวมระบบ', shortName: 'แดชบอร์ด', icon: <FiGrid className="w-5 h-5" />,          roles: ['ADMIN'] },
    {
      ...
      subItems: [
        ...
        { to: '/master-data?tab=strategy',      name: 'ยุทธศาสตร์หลัก',       shortName: 'ยุทธฯ หลัก', icon: <FiDatabase className="w-4 h-4" /> },
        { to: '/master-data?tab=sub-strategy',  name: 'ยุทธศาสตร์ย่อย',       shortName: 'ยุทธฯ ย่อย', icon: <FiGitCommit className="w-4 h-4" /> },
        { to: '/master-data?tab=indicator',     name: 'ตัวชี้วัด',             shortName: 'ตัวชี้วัด', icon: <FiGitCommit className="w-4 h-4" /> },
        { to: '/projects',                      name: 'โครงการยุทธศาสตร์',    shortName: 'โครงการ',   icon: <FiBriefcase className="w-4 h-4" /> },
