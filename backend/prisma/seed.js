...
async function main() {
  ...
  const s1 = await prisma.strategy.upsert({
    where: { code: 'S1' },
    update: { name: 'การพัฒนาท้องถิ่นด้านเศรษฐกิจ: ยกระดับเศรษฐกิจฐานรากบนหลักปรัชญาของเศรษฐกิจพอเพียง' },
    create: { code: 'S1', name: 'การพัฒนาท้องถิ่นด้านเศรษฐกิจ: ยกระดับเศรษฐกิจฐานรากบนหลักปรัชญาของเศรษฐกิจพอเพียง' }
  });
  const s2 = await prisma.strategy.upsert({
    where: { code: 'S2' },
    update: { name: 'การพัฒนาท้องถิ่นด้านสังคม: ส่งเสริมคุณภาพชีวิตและภูมิปัญญาท้องถิ่นเพื่อความมั่นคงและยั่งยืนเชิงพื้นที่' },
    create: { code: 'S2', name: 'การพัฒนาท้องถิ่นด้านสังคม: ส่งเสริมคุณภาพชีวิตและภูมิปัญญาท้องถิ่นเพื่อความมั่นคงและยั่งยืนเชิงพื้นที่' }
  });
  const s3 = await prisma.strategy.upsert({
    where: { code: 'S3' },
    update: { name: 'การพัฒนาท้องถิ่นด้านสิ่งแวดล้อม: การเสริมสร้างชุมชนรักษ์โลกเพื่อรับมือการเปลี่ยนแปลงสภาพภูมิอากาศ' },
    create: { code: 'S3', name: 'การพัฒนาท้องถิ่นด้านสิ่งแวดล้อม: การเสริมสร้างชุมชนรักษ์โลกเพื่อรับมือการเปลี่ยนแปลงสภาพภูมิอากาศ' }
  });
  const s4 = await prisma.strategy.upsert({
    where: { code: 'S4' },
    update: { name: 'การพัฒนาท้องถิ่นด้านการศึกษา: การติดอาวุธทางปัญญาเพื่อการพัฒนาการศึกษาเชิงพื้นที่อย่างยั่งยืน' },
    create: { code: 'S4', name: 'การพัฒนาท้องถิ่นด้านการศึกษา: การติดอาวุธทางปัญญาเพื่อการพัฒนาการศึกษาเชิงพื้นที่อย่างยั่งยืน' }
  });
