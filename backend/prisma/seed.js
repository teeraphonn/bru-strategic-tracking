...
async function main() {
  ...
  await prisma.indicator.upsert({
    where: { code: 'MP5.1' },
    update: { name: 'โครงการความร่วมมือขับเคลื่อนการพัฒนาเชิงพื้นที่ระดับภูมิภาค', subStrategyId: ss5_1.id },
    create: { code: 'MP5.1', name: 'โครงการความร่วมมือขับเคลื่อนการพัฒนาเชิงพื้นที่ระดับภูมิภาค', subStrategyId: ss5_1.id }
  });
  await prisma.indicator.upsert({
    where: { code: 'MP6.1' },
    update: { name: 'โครงการความร่วมมือขับเคลื่อนการพัฒนาเชิงพื้นที่ระดับประเทศ', subStrategyId: ss6_1.id },
    create: { code: 'MP6.1', name: 'โครงการความร่วมมือขับเคลื่อนการพัฒนาเชิงพื้นที่ระดับประเทศ', subStrategyId: ss6_1.id }
  });
